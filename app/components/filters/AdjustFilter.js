  ...
  adjustFilter: {
    frag: `
      ...
      void main() {
        ...
        vec3 filter = texture2D(image, st).rgb;
...
module.exports = GL.createComponent(
  ({ saturation, brightness, contrast, hue, sepia, gray, mixFactor, image, ...rest }) =>
    <GL.Node
      {...rest}
      shader={shaders.adjustFilter}
      uniforms={{ saturation, brightness, contrast, hue, sepia, gray, mixFactor, image }}
    />,
  { displayName: "AdjustFilter" });